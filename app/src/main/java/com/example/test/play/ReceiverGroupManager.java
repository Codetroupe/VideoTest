package com.example.test.play;

import android.content.Context;

import com.example.test.cover.CompleteCover;
import com.example.test.cover.ControllerCover;
import com.example.test.cover.ErrorCover;
import com.example.test.cover.GestureCover;
import com.example.test.cover.LoadingCover;
import com.kk.taurus.playerbase.receiver.GroupValue;
import com.kk.taurus.playerbase.receiver.ReceiverGroup;

import static com.example.test.play.DataInter.ReceiverKey.KEY_COMPLETE_COVER;
import static com.example.test.play.DataInter.ReceiverKey.KEY_CONTROLLER_COVER;
import static com.example.test.play.DataInter.ReceiverKey.KEY_ERROR_COVER;
import static com.example.test.play.DataInter.ReceiverKey.KEY_GESTURE_COVER;
import static com.example.test.play.DataInter.ReceiverKey.KEY_LOADING_COVER;
