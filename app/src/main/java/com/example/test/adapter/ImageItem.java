 ...
 * @date 2015/5/15
 */
public class ImageItem implements AdapterItem<ViewPageModel> {

    private int mOldImageUrl = 0;

    private GlideImageView mIv;
    ...
    public int getLayoutResId() {
        return R.layout.adapter_item_view_image;
    }

    @Override
    public void bindViews(@NonNull View root) {
        mIv = (GlideImageView) root;
    }
