...
public class demo extends Activity {
    ...
    protected void initData() {
        ...
        String shareHotData ="粤菜,浙菜,苏菜,粤菜,浙菜,苏菜,粤菜,浙菜,苏菜";
        ...
        msearchLy.initData(skills, skillHots, new mSearchLayout.setSearchCallBackListener() {
            ...
            public void ClearOldData() {
                //清除历史搜索记录  更新记录原始数据
                Toast.makeText(demo.this , "清除历史搜索记录" ,Toast.LENGTH_LONG).show();
            }
            @Override
            public void SaveOldData(ArrayList<String> AlloldDataList) {
                //保存所有的搜索记录
                Toast.makeText(demo.this , "保存所有的搜索记录" ,Toast.LENGTH_LONG).show();
            }
        });
    }
